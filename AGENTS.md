...
Read the ADRs that cover what you are changing. There are 93.
...
- Schema: version 10.
- Commands (47): `paths`, `ingest`, `activity`, `input`, `notes`, `web`, `build`, `report`,
  `profile`, `caption`, `singles`, `screens`, `subjects`, `themes`,
  `index`, `ask`, `tell`, `trend`, `lifecycle`, `insights`, `discover`,
  `compare`, `drift`, `places`, `trips`, `suggest`, `today`, `now`, `correct`,
